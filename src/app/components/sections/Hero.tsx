            ...
            <div className="relative z-10 text-center text-zinc-100 px-6 max-w-4xl">
                ...
                >
                    <Link href="/products" className="block w-full sm:w-auto">
                        <button className="w-full bg-[#C5A880] text-[#121212] px-12 py-4 rounded-full font-semibold tracking-widest text-xs hover:bg-zinc-100 transition-all duration-300 uppercase shadow-xl hover:shadow-[#C5A880]/20">
                            Explore Collection
                        </button>
                    </Link>
                    <Link href="/about" className="block w-full sm:w-auto">
                        <button className="w-full border border-zinc-400/40 backdrop-blur-md text-zinc-200 px-12 py-4 rounded-full font-medium tracking-widest text-xs hover:bg-zinc-100 hover:text-[#121212] hover:border-zinc-100 transition-all duration-300 uppercase">
                            Our Story
                        </button>
                    </Link>
                </motion.div>
